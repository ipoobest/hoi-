...
import OverallProductLink from "@/views/report/grid/OverallProductLink";

import { getProductLottoTable, getSumProductLottos } from "@/api/productLotto";
import { getProductById } from "@/api/product";

import { columnDefs } from "@/views/report/grid/OverAllProductColumnDefs.js";
...
export default {
  ...
  created() {
    ...
    this.$EventBus.$on(
      "onReportOverallProductRefresh",
      this.onReportOverallProductRefresh
    );
  ...
  methods: {
    ...
    onGridReady(params) {
      ...
      this.gridApi.setDatasource({
        ...
        getRows: params => {
          ...
          getSumProductLottos(params.filterModel)
            .then(res => {
    ...
    onRowDoubleClicked(params) {
      this.$router.push({
        path: "/report/overall/round/" + params.data._id.toString()
      });
    }
  }
};
