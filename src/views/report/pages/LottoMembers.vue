        ...
        <base-material-card>
          ...
          <div style="margin-top: 1rem; min-height: 700px; height: auto;">
            ...
            <div style="margin-top: 3rem; height: auto;">
              <OrderItemTable ref="item" :current-order="currentOrder" />
            </div>
          </div>
        </base-material-card>
      </v-col>
...
import { columnDefs } from "@/views/report/grid/LottoMembersColumnDefs.js";
...
export default {
  ...
  methods: {
    ...
    onSelectionChanged() {
      ...
      this.currentOrder = selectedRows;
    },
    onSubmit() {
