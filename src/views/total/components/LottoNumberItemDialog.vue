    ...
    <v-card>
      ...
      <v-card-text>
        <v-row no-gutters>
          ...
          <v-col cols="2" class="text-right">
            <v-card class="pa-5" outlined tile>
              <span class="text-h2">{{ $t("pay_amount") }}</span>
            </v-card>
          </v-col>
          <v-col cols="4">
            <v-card class="pa-5" outlined tile>
              <span v-if="summary" class="text-h2 font-weight-bold">{{
                $Numeral(summary.totalPay).format("0,0.00")
              }}</span>
            </v-card>
          </v-col>
          <v-col cols="2" class="text-right">
          ...
          <v-col cols="4">
            <v-card class="pa-5" outlined tile>
              <span
                v-if="summary2"
                class="text-h2 font-weight-bold red--text"
                >{{ $Numeral(summary2.totalPay).format("0,0.00") }}</span
              >
            </v-card>
          </v-col>
        </v-row>
...
import { columnDefs } from "@/views/total/grid/LottoNumberItemColumnDefs";
...
import BillNo from "@/views/total/grid/BillNo";

import LottoNumberItemBottomSheet from "@/views/total/components/LottoNumberItemBottomSheet";
export default {
  components: {
    AgGridVue,
    LottoNumberItemBottomSheet,
